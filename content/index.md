...
- [手を動かしなら学ぶ Analytics サービス入門](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-Analytics-2021-reg-event.html?trk=aws_introduction_page){target=_blank}  
...
- [Amazon Redshift Serverless データ分析セルフハンズオン](https://pages.awscloud.com/JAPAN-launch-GC-RedshiftServerless_Handson-2022-reg.html){target=_blank}  
...
- [Connected Vehicle Workshop](https://dcj71ciaiav4i.cloudfront.net/B27AC3C0-2E0B-11EB-A818-F1507A734DA4/index.html){target=_blank}  
...
- [Amazon Athena Federated Query 経由で Amazon DynamoDB のデータを Amazon QuickSight で可視化するハンズオン](https://aws.amazon.com/jp/blogs/news/athena-federated-query-dynamodb-quicksight/){target=_blank}  
...
- [AWS Glue DataBrew ハンズオン](https://dcj71ciaiav4i.cloudfront.net/322031A0-7CA9-11EB-8D02-B70DEDD8DFCB/){target=_blank}  
...
- [Amazon Athena ACID transaction workshop](https://github.com/harunobukameda/Amazon-Athena-ACID-transcation/blob/main/Amazon%20Athena%20ACID%20transaction%20workshop.pdf){target=_blank}  
...
- [Amazon MSK ワークショップ](https://github.com/harunobukameda/Amazon-MSK/blob/main/Amazon%20MSK%20%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
...
- [AWS Glue DataBrew ワークショップ](https://github.com/harunobukameda/AWS-Glue-DataBrew/blob/main/AWS%20Glue%20DataBrew%20%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
...
- [AWS Glue Studio ワークショップ](https://github.com/harunobukameda/AWS-Glue-Studio/blob/main/AWS%20Glue%20Studio%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
...
- [はじめてのモダンデータ解析基盤](https://github.com/harunobukameda/Amazon-Redshift-Spectrum-AWS-Glue-Amazon-Athena-Amazon-S3-Select/blob/master/datalake-handson-text_20220327.pdf){target=_blank}  
...
- [Amazon Managed Workflows for Apache Airflow (MWAA) ハンズオン ](https://github.com/harunobukameda/Amazon-Managed-Workflows-for-Apache-Airflow-MWAA-/blob/main/Amazon%20Managed%20Workflows%20for%20Apache%20Airflow.pdf){target=_blank}  
...
- [NFT Workshop](https://dcj71ciaiav4i.cloudfront.net/31278980-D264-11EC-BB2B-AB3D7B3B0CB5/){target=_blank}  
...
- [QLDB ハンズオン](https://catalog.us-east-1.prod.workshops.aws/workshops/6ee941b7-bf88-4455-b285-3745bfc35754/ja-JP){target=_blank}  
このハンズオンでは Amazon Quantum Ledger Database を使った実践的な台帳アプリケーションの構築を体験できます。  
tag : Amazon QLDB  

- [Amazon Managed Blockchain (Hyperledger Fabric) ワークショップ](https://github.com/harunobukameda/Amazon-Managed-Blockchain/blob/main/Amazon%20Managed%20Blockchain.pdf){target=_blank}  
...
- [Amazon QLDB ワークショップ](https://github.com/harunobukameda/Amazon-QLDB/blob/main/Amazon%20QLDB%20%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
...
- [RDS Proxy / Lambda ワークショップ](https://github.com/harunobukameda/RDS-Proxy-AWS-Lambda/blob/main/RDS%20Proxy.pdf){target=_blank}  
Lambda 関数から、RDS Proxy を経由して RDS に接続する内容を学習できるワークショップです。  
tag : RDS Proxy, AWS Lambda  

- [Amazon Neptune グラフデータ可視化ハンズオン](https://github.com/harunobukameda/Amazon-Neptune/blob/master/handson.pdf){target=_blank}  
...
- [AWS Code サービス群を活用して、CI/CD のための構成を構築しよう！](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-cicd-2020-reg-event-LP.html?trk=aws_introduction_page){target=_blank}  
...
- [AWS Fault Injection Simulator ワークショップ](https://github.com/harunobukameda/AWS-FIS-Auto-Scaling/blob/main/AWS%20Fault%20Injection%20Simulator%20%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
...
- [Amazon WorkSpaces 入門](https://catalog.us-east-1.prod.workshops.aws/workshops/ba8389fd-99a1-4010-a95e-d691a2c08311/ja-JP){target=_blank}  
...
- [Amazon AppStream 2.0 入門](https://catalog.us-east-1.prod.workshops.aws/workshops/e324c13e-2ded-4da2-ad9c-f685305156ac/ja-JP){target=_blank}  
...
- [AWS Amplify Workshop with Vue.js](https://catalog.workshops.aws/amplify-vue3){target=_blank}  
...
- [Amplify SNS Workshop](https://amplify-sns.workshop.aws/ja/){target=_blank}  
...
- [AWS Amplify を用いた Web サイトの構築方法を学ぼう](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-amplify-2022-reg-event.html?trk=aws_introduction_page){target=_blank}  
AWS Amplify という Web フロントエンド、モバイルアプリの開発を加速させるサービスを利用した Web サイトの構築方法について理解を深めることができます。  
tag : AWS Amplify, AWS AppSync, Amazon Cognito, Amazon DynamoDB  

- [Amazon Location Service ハンズオン](https://github.com/harunobukameda/Amazon-Location-Service/blob/main/location%20service%20workshop.pdf){target=_blank}  
...
- [AWS Amplify Admin UI ワークショップ](https://github.com/harunobukameda/AWS-Amplify-Admin-UI/blob/main/AWS%20Amplify%20Admin%20UI%20%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
...
- [Amazon GameLift Realtime Server Workshop](https://catalog.us-east-1.prod.workshops.aws/workshops/bccf7c14-8f6f-441b-a4ff-fd6a2b402892/ja-JP){target=_blank}  
...
- [AWS IoT Core 初級ハンズオン](https://catalog.us-east-1.prod.workshops.aws/workshops/b3e0b830-79b8-4c1d-8a4c-e10406600035/ja-JP){target=_blank}  
...
- [AWS IoT Jumpstart](https://catalog.us-east-1.prod.workshops.aws/workshops/001cd52d-8105-4da9-a0c2-ee391260e0c7/ja-JP){target=_blank}  
...
- [AWS IoT Analytics ハンズオン](https://catalog.us-east-1.prod.workshops.aws/workshops/03a4f79f-6971-441f-bc12-e8b755392d2c/ja-JP){target=_blank}  
...
- [AWS IoT Device Management Workshop](https://catalog.us-east-1.prod.workshops.aws/workshops/7c2b04e7-8051-4c71-bc8b-6d2d7ce32727/ja-JP){target=_blank}  
...
- [AWS IoT Device Defender ハンズオン](https://catalog.us-east-1.prod.workshops.aws/workshops/90cbb951-dbf8-4f66-b994-c74072f2232c/ja-JP){target=_blank}  
...
- [AWS IoT EduKit ワークショップ](https://catalog.us-east-1.prod.workshops.aws/workshops/0fc6bf2c-f59c-4490-9254-ef604942f5d3/ja-JP){target=_blank}  
...
- [AWS IoT Events 初級ハンズオン](https://catalog.us-east-1.prod.workshops.aws/workshops/4ae2dd76-c365-42e4-b66b-ed475363d562/ja-JP){target=_blank}  
このハンズオンでは AWS IoT Events を利用し、コードレスで複雑な状態管理のアプリケーションを構築する方法について学びます。  
tag : AWS IoT Core, AWS IoT Events, Amazon SNS  

- [AWS IoT Greengrass 2.0 入門ハンズオン](https://catalog.us-east-1.prod.workshops.aws/workshops/5ecc2416-f956-4273-b729-d0d30556013f/ja-JP){target=_blank}  
...
- [AWS IoT SiteWise Edge Workshop](https://catalog.us-east-1.prod.workshops.aws/workshops/9b243796-bda0-45f3-a2be-f50fcd3af435/ja-JP/){target=_blank}  
...
- [AWS IoT SiteWise ハンズオン](https://iot-sitewise.workshop.aws/ja/){target=_blank}  
...
- [IoT Core for LoRaWAN workshop](https://catalog.us-east-1.prod.workshops.aws/workshops/b95a6659-bd4f-4567-8307-bddb43a608c4/ja-JP){target=_blank}  
...
- [AWS IoT TwinMaker workshop for beginners](https://catalog.us-east-1.prod.workshops.aws/workshops/f3e15719-fcf0-4f2c-8105-4fae1aedba33/ja-JP){target=_blank}  
...
- [Amazon Kinesis Video Streams WebRTC Workshop](https://catalog.us-east-1.prod.workshops.aws/workshops/a391c4b3-5a5c-4b2a-a92a-681985d108f5/ja-JP/){target=_blank}  
...
- [Amazon Kinesis Video Streams ハンズオン](https://catalog.us-east-1.prod.workshops.aws/workshops/b95b9381-baf0-4bef-ba31-63817d54c2a6/ja-JP){target=_blank}  
...
- [SageMaker Immersion Day](https://catalog.us-east-1.prod.workshops.aws/workshops/63069e26-921c-4ce1-9cc7-dd882ff62575/ja-JP){target=_blank}  
...
- [SageMaker Canvas Immersion Day](https://catalog.workshops.aws/canvas-immersion-day/ja-JP){target=_blank}  
...
- [SageMaker Workshop Linear Learner with MNIST](https://dcj71ciaiav4i.cloudfront.net/81427A00-A999-11EB-A30A-E311773AC105/){target=_blank}  
...
- [Workshop for AWS Academy Learner Lab (SageMaker R-kernel)](https://dcj71ciaiav4i.cloudfront.net/4FE06AD0-A999-11EB-A30A-E311773AC105/){target=_blank}  
SageMaker Notebook で、R を扱うハンズオンです。iris データセットを使いながら、R で散布図や標準偏差、回帰直線などを利用する手順を体験いただけます。  
tag : Amazon SageMaker, R  

- [機械学習中級者向けハンズオン : Amazon SageMaker Hands-on Workshop](https://dcj71ciaiav4i.cloudfront.net/BE9D0570-8AD9-11EB-AD13-537EEE6AAE51/){target=_blank}  
...
- [機械学習入門者向けハンズオン : 機械学習で画像を分類してみよう](https://dcj71ciaiav4i.cloudfront.net/E33695C0-835B-11EB-8E80-138DCE1C124F/){target=_blank}  
このハンズオンでは、これから機械学習を始めようと考えている方が、プログラミングを通じて機械学習について理解することを目的としています。機械学習には Python を利用しますので、Python を使ったプログラミング経験があるとスムーズです。  
tag : Amazon SageMaker, scikit-learn  

- [AWS Managed AI/ML サービス はじめの一歩](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-AIML-2021-reg-event.html?trk=aws_introduction_page){target=_blank}  
...
- [AWS の機械学習サービスのサンプルコードのためのレポジトリ](https://github.com/aws-samples/aws-ml-jp){target=_blank}  
AWS の機械学習サービスのサンプルコードのためのレポジトリです。  
tag : Repository  

- [Amazon Lookout for Equipment Pipeline Workshop](https://catalog.us-east-1.prod.workshops.aws/workshops/ac11f205-6c9d-417e-b656-0aa26ef873f7/ja-JP){target=_blank}  
...
- [Amazon Lookout for Metrics ワークショップ](https://github.com/harunobukameda/Amazon-Lookout-for-Metrics/blob/main/Amazon%20Lookout%20for%20Metrics%20%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
...
- [Amazon Lookout for Vision Workshop](https://catalog.us-east-1.prod.workshops.aws/workshops/cbfb2625-416f-45e3-88b2-b68a1d25dab2/ja-JP){target=_blank}  
...
- [Amazon Lookout for Vison ワークショップ](https://github.com/harunobukameda/Amazon-Lookout-for-Vision/blob/main/Amazon%20Lookout%20for%20Vison%20%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
...
- [Amazon Personalize ハンズオン](https://github.com/harunobukameda/Amazon-Personalize-Handson/blob/master/personalize%2Bhandson.pdf){target=_blank}  
...
- [Amazon Rekognition Immersion Day](https://dcj71ciaiav4i.cloudfront.net/D5606580-B8E8-11EB-BFFC-8979D922AC62/){target=_blank}  
...
- [Amazon SageMaker Canvas ワークショップ](https://github.com/harunobukameda/Amazon-SageMaker-Canvas/blob/main/SageMaker%20Canvas.pdf){target=_blank}  
Amazon SageMaker Canvas は AWS が提供する構造化データを対象とした機 械学習をノーコードで実現できるサービスです。使い方を学習できるワークショップです。  
tag : Amazon SageMaker Canvas  

- [Amazon SageMaker JumpStart Workshop](https://github.com/harunobukameda/Amazon-SageMaker-JumpStart/blob/main/Amazon%20SageMaker%20JumpStart%20Workshop.pdf){target=_blank}  
...
- [AWS RoboMaker ハンズオン](https://github.com/harunobukameda/Amazon-Robomaker/blob/master/RoboMakerHandsonLoft20191008.pdf){target=_blank}  
このハンズオンでは強化学習を⾏うロボットアプリケーションを使い、AWS RoboMaker の機能のうち、「開発環 境」と「シミュレーション」機能について体験できます。  
tag : AWS RoboMaker  

- [WordPress を利用した AmazonTranslate Polly Rekognition ハンズオン](https://github.com/harunobukameda/Amazon-Polly-Amazon-Rekogniton-Amazon-Translate-Handson-/blob/master/WordPress%E3%82%92%E5%88%A9%E7%94%A8%E3%81%97%E3%81%9FAmazonTranslate-Polly-Rekognition%E3%83%8F%E3%83%B3%E3%82%BA%E3%82%AA%E3%83%B3.zip){target=_blank}  
...
- [はじめての自然言語処理（NLP：Natural Language Processing）ハンズオン](https://github.com/harunobukameda/Amazon-Translate---Amazon-Polly---Amazon-Transcribe---Amazon-Comprehend---Amazon-Elasticsearch/blob/master/Handson.pdf){target=_blank}  
...
- [AWS DeepRacer Workshop](https://catalog.us-east-1.prod.workshops.aws/workshops/03f7e662-e3b1-4c5b-8fbe-b6af0c00c7b2/ja-JP){target=_blank}  
AWS DeepRacer の強化学習モデルを作る方法を学ぶハンズオンです。  
tag : AWS DeepRacer  

- [Amazon CodeGuru ワークショップ](https://github.com/harunobukameda/Amazon-CodeGuru-Reviewer/blob/main/Amazon%20CodeGuru%20%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
...
- [Amazon DevOps Guru ハンズオン](https://github.com/harunobukameda/Amazon-DevOps-Guru/blob/main/Amazon%20DevOps%20Guru%20%E3%83%8F%E3%83%B3%E3%82%BA%E3%82%AA%E3%83%B3.pdf){target=_blank}  
...
- [Amazon Forecast ハンズオン](https://github.com/harunobukameda/Amazon-Forecast/blob/master/Amazon%20Forecast%20%E3%83%8F%E3%83%B3%E3%82%BA%E3%82%AA%E3%83%B3.pdf){target=_blank}  
Amazon Forecast は AWS が提供している時系列データをもとに予 測を行う機械学習サービスです。このハンズオンでは、Forecast の基本的な使い方を学習いただけます。  
tag : Amazon Forecast  

- [Amazon Lex ワークショップ](https://github.com/harunobukameda/Amazon-Lex/blob/main/Amazon%20Lex%20%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
...
- [One Observability Workshop](https://catalog.workshops.aws/observability/ja-JP){target=_blank}  
...
- [AWS Systems Manager ハンズオン](https://catalog.us-east-1.prod.workshops.aws/workshops/7e60f6e3-0c8f-488a-bedc-632aa8d526ea/ja-JP){target=_blank}  
...
- [AWS Systems Managerを使ったサーバ管理はじめの一歩編](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-systems-manager-2022-reg-event.html?trk=aws_introduction_page){target=_blank}  
...
- [AWS 環境のコード管理 AWS CloudFormationで Web システムを構築する](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-cfn-2020-reg-event-LP.html?trk=aws_introduction_page){target=_blank}  
一般的な Web システム環境を例にして、AWS CloudFormationの使用方法およびクラウドにおける構成管理の考え方が学べます。  
tag : CloudFormation  

- [監視編 サーバーのモニタリングの基本を学ぼう](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-monitoring-2020-reg-event-LP.html?trk=aws_introduction_page){target=_blank}  
Amazon CloudWatchを利用した AWS における監視の基本が学べます。WordPressを題材に、どのようにAWSで監視していくかを体験できます。  
tag : Amazon CloudWatch  

- [Control Tower Workshops](https://controltower.aws-management.tools/ja/immersionday/){target=_blank}  
AWS Control Tower サービスのデプロイの概要をハイレベルで学ぶことができます。  
tag : AWS Control Tower  

- [Systems Manager & QuickSight ハンズオン](https://catalog.us-east-1.prod.workshops.aws/workshops/b97f7cb6-0ec4-41c7-97ea-c4156f4f1e0d/ja-JP){target=_blank}  
...
- [Amazon Managed Service for Grafana (AMG) Workshop](https://github.com/harunobukameda/Amazon-Managed-Service-for-Grafana/blob/main/Amazon%20Managed%20Service%20for%20Grafana.pdf){target=_blank}  
Grafana を活用した フルマネージドでセキュアなデータ可視化サービスです。AMG を使って、CloudWatch のメトリクスを可視化する方法を学習できます。  
tag : Amazon Managed Grafana  

- [Amazon Managed Service for Prometheus (AMP) ハンズオン](https://github.com/harunobukameda/Amazon-Prometheus-Amazon-Grafana-AWS-Fargate-for-ECS/blob/main/Amazon%20Managed%20Service%20for%20Prometheus.pdf){target=_blank}  
...
- [AWS CDK v2 ワークショップ](https://github.com/harunobukameda/AWS-CDK-v2/blob/main/AWS%20CDK%20v2%20%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
クラウドインフラをコードで定義し、プロビジョニングするための AWS CDK v2 を体験いただけるワークショップです。  
tag : AWS CDK v2  

- [AWS Proton ワークショップ](https://github.com/harunobukameda/AWS-Proton/blob/main/AWS%20Proton%20%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
...
- [CloudWatch Evidently ワークショップ](https://github.com/harunobukameda/Amazon-CloudWatch-Evidently/blob/main/CloudWatch%20Evidently%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
機能フラグとしても知られているダークローンチの実装と A/B テストを簡単に実現するCloud Watch Evidently を皆で触ってみます。  
tag : Amazon CloudWatch Evidently  

- [CloudWatch RUM ワークショップ](https://github.com/harunobukameda/Amazon-CloudWatch-RUM/blob/main/CloudWatch%20RUM%20%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
...
- [AWS で動画配信をはじめよう](https://catalog.us-east-1.prod.workshops.aws/workshops/311aa4b5-cad5-4316-95d1-b88bc732fdd5/ja-JP){target=_blank}  
...
- [Amazon IVSを使ったLive配信の構築](https://catalog.us-east-1.prod.workshops.aws/workshops/022adf04-0ff9-49af-848f-993e42575540/ja-JP){target=_blank}  
...
- [vMixをEC2で稼働させるクラウド制作](https://catalog.us-east-1.prod.workshops.aws/workshops/0205fa06-d4e3-4299-8458-0a3c169e301d/ja-JP){target=_blank}  
...
- [Amazon Interactive Video Service ワークショップ](https://github.com/harunobukameda/Amazon-IVS/blob/main/IVS%20Workshop.pdf){target=_blank}  
...
- [AWS Application Migration Service(MGN) ハンズオン](https://d2h9aujg4hgxod.cloudfront.net/51E3A3D0-D70A-11EB-91FC-CFB7976F85AB/index.html){target=_blank}  
...
- [AWS Migration Hub Refactor Spaces ワークショップ](https://github.com/harunobukameda/AWS-Migration-Hub-Refactor-Spaces/blob/main/AWS%20Migration%20Hub%20Refactor%20Spaces%20%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
...
- [AWS上にセキュアなプライベートネットワーク空間を作成する](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-Network1-2020-reg-event-LP.html?trk=aws_introduction_page){target=_blank}  
Amazon VPC の基本および VPC 内の通信と VPC から VPC 外に接続する方法について学べます。  
tag : Amazon VPC, VPC Endpoint  

- [AWS Client VPN Basic ハンズオン](https://catalog.us-east-1.prod.workshops.aws/workshops/be2b90c2-06a1-4ae6-84b3-c705049d2b6f/ja-JP){target=_blank}  
...
- [クライアントVPNをつかって、リモート接続環境を構築しよう](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-Network-3-2022-reg-event.html?trk=aws_introduction_page){target=_blank}  
リモート環境からソフトウェアVPN接続を使って、VPC内へのリソースへアクセスする方法を学ぶことが可能です。  
tag : AWS Client VPN  

- [AWS 上で静的な Web サイトを公開しよう！](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-StaticWebsiteHosting-2020-reg-event-LP.html?trk=aws_introduction_page){target=_blank}  
...
- [Amazon VPC間およびAmazon VPCとオンプレミスのプライベートネットワーク接続](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-Network2-202009-reg-event-LP.html?trk=aws_introduction_page){target=_blank}  
Amazon VPC間の接続方法とVPCとオンプレミスの接続方法の解説、VPCピアリング接続、AWS Site-to-Site VPNに関するハンズオンがご利用いただけます。  
tag : AWS Site-to-Site VPN, VPC ピアリング  

- [Amazon CloudFrontおよびAWS WAFを用いて エッジサービスの活用方法を学ぼう](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-CF_WAF-2021-reg-event.html?trk=aws_introduction_page){target=_blank}  
Amazon CloudFrontやAWS WAFといったAWSのエッジサービスをハンズオン形式でご活用いただき、その導入メリットや実際の運用方法を学べます。  
tag : Amazon CloudFront, AWS WAF  

- [Workshop for AWS Educate (CloudFront/S3)](https://dcj71ciaiav4i.cloudfront.net/7CB85370-A998-11EB-A09B-259812622FA1/){target=_blank}  
CloudFront と S3 を利用して、サーバレスな Web 配信を体験いただける内容です。  
tag : Amazon S3, Amazon CloudFront  

- [AWS Transit Gateway ハンズオン](https://catalog.us-east-1.prod.workshops.aws/workshops/e0d1c19d-c80b-4695-a3fc-5c4a25132f47/ja-JP/){target=_blank}  
...
- [Amazon VPC IP Address Manager ワークショップ](https://github.com/harunobukameda/Amazon-VPC-IP-Address-Manager/blob/main/IPAM%20Workshop.pdf){target=_blank}  
...
- [AWS Network Firewall ハンズオン](https://github.com/harunobukameda/AWS-Network-Firewall/blob/main/AWS%20Network%20Firewall%20%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
...
- [VPC Reachability Analyzer ワークショップ](https://github.com/harunobukameda/VPC-Reachability-Analyzer/blob/main/VPC%20Reachability%20Analyzer%20%E3%83%AF%E3%83%BC%E3%82%AF%E3%82%B7%E3%83%A7%E3%83%83%E3%83%97.pdf){target=_blank}  
...
## SaaS
- [Buiding SaaS Solutions on AWS](https://www.eventbox.dev/published/lesson/saas-factory-bootcamp-jp/){target=_blank}  
...
## SAP
- [SAP on AWS Immersion Day - SAP HANA構築](https://catalog.workshops.aws/sap-on-aws/ja-JP){target=_blank}  
...
- [SAP HANA on AWS Advanced workshop](https://catalog.workshops.aws/sap-hana-suse-ha/ja-JP){target=_blank}  
...
- [AWS アカウントの作り方 & IAM 基本のキ](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-1st-Step-2022-reg-event.html?trk=aws_introduction_page){target=_blank}  
AWS アカウントの作成と IAM に関しての説明／ハンズオンを行います。IAM ユーザーや IAM ポリシーなどの基本がわかり設定できるようになります。  
tag :  AWS Identity and Access Management (IAM)  

- [アカウント作成後すぐやるセキュリティ対策](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-Security-1-2022-reg-event.html?trk=aws_introduction_page){target=_blank}  
...
- [AWS 環境における脅威検知と対応](https://scaling-threat-detection.awssecworkshops.jp/){target=_blank}  
...
- [ゼロトラストワークショップ](https://catalog.us-east-1.prod.workshops.aws/workshops/dc413216-deab-4371-9e4a-879a4f14233d/ja-JP){target=_blank}  
...
- [開発者のためのセキュリティ](https://dcj71ciaiav4i.cloudfront.net/DE7AE230-18E7-11EC-96D4-A3A8E3F74BCA/){target=_blank}  
...
- [GuardDuty Workshop](https://d2h9aujg4hgxod.cloudfront.net/72704A00-FCD4-11EB-B3AC-898E20057A09/index.html){target=_blank}  
...
- [Cognito API ハンズオン](https://dcj71ciaiav4i.cloudfront.net/591796E0-D127-11EB-A6A5-FB83B2BAF6EE/){target=_blank}  
このハンズオンではこの Cognito ユーザプールに焦点をあて、基礎から理解するために直接 API の操作を行ってみるハンズオンとなっています。  
tag : Amazon Cognito  

- [SIEM on Amazon OpenSearch Service ワークショップ](https://catalog.us-east-1.prod.workshops.aws/workshops/60a6ee4e-e32d-42f5-bd9b-4a2f7c135a72/ja-JP){target=_blank}  
...
- [アイデンティティ ラウンドロビン](https://github.com/skiritan/aws-identity-round-robin-workshop/blob/master/docs/index.md){target=_blank}  
...
- [サーバーレスセキュリティワークショップ](https://github.com/aws-samples/aws-serverless-security-workshop-jp){target=_blank}  
...
- [Amazon Macieによるデータ検出と分類](https://catalog.workshops.aws/data-discovery-with-macie/ja-JP){target=_blank}  
...
- [AWS Secrets Manager を使用した認証情報の保存、取得、管理](https://catalog.us-east-1.prod.workshops.aws/workshops/92e466fd-bd95-4805-9f16-2df07450db42/ja-JP/){target=_blank}  
...
- [AWS SAM を使ってテンプレートからサーバーレスな環境を構築する](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-Serverless-2-2022-reg-event.html?trk=aws_introduction_page){target=_blank}  
...
- [はじめてのサーバーレス](https://github.com/harunobukameda/AWS-Amplify-AWS-Lambda-Amazon-DynamoDB-AWS-API-Gateway-Amazon-Cognito/blob/master/Scenario.pdf){target=_blank}  
...
- [サービス連携の体験ハンズオン](https://dcj71ciaiav4i.cloudfront.net/49D0D220-8D0F-11EB-8F39-FD9A62BABEEC/){target=_blank}  
...
- [AWS Step Functions 入門 - ビジュアルツールを使ってローコードにワークフローを作成する](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-StepFunctions-2022-reg-event.html?trk=aws_introduction_page){target=_blank}  
...
- [AWS Lambda と AWS AI Services を組み合わせて作る音声文字起こし & 感情分析パイプライン](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-Serverless-3-2022-reg-event.html?trk=aws_introduction_page){target=_blank}  
...
- [サーバーレスアーキテクチャで翻訳 Web API を構築する](https://pages.awscloud.com/JAPAN-event-OE-Hands-on-for-Beginners-Serverless-1-2022-reg-event.html?trk=aws_introduction_page){target=_blank}  
...
- [Amazon FSx for Windows File Server ワークショップ](https://github.com/aws-samples/amazon-fsx-workshop/tree/master/windows-file-server/JP/01-access-as-environment){target=_blank}  
...
- [Amazon FSx for Windows File Server ハンズオン](https://github.com/harunobukameda/Amazon-FSx-for-Windows-File-Server/blob/main/FSx_Windows_%E3%83%8F%E3%83%B3%E3%82%BA%E3%82%AA%E3%83%B3_20210219.pdf){target=_blank}  
Amazon FSx for Windows File Server を使って、フルマネージドな共有ファイルストレージを構築いただけるハンズオンです。  
tag : Amazon FSx for Windows File Server  

- [Amazon FSx for NetApp ONTAP ワークショップ](https://github.com/aws-samples/amazon-fsx-workshop/tree/master/netapp-ontap/JP){target=_blank}  
...
- [DataSync を使った FSx for Windows File Server へのマイグレーション](https://github.com/aws-samples/aws-datasync-fsx-windows-migration/tree/master/JP){target=_blank}  
このハンズオンでは、DataSync を使った FSx for Windows File Server へのマイグレーション方法を学習いただけます。  
tag : Amazon FSx for NetApp ONTAP, AWS DataSync  

- [AWS DataSync と AWS Storage Gateway を使った NFS サーバーマイグレーション](https://github.com/aws-samples/aws-datasync-migration-workshop/tree/master/workshops/nfs-migration/JP){target=_blank}  
...
- [Amazon FSx File Gateway ワークショップ](https://github.com/aws-samples/amazon-fsx-workshop/tree/master/file-gateway/JP/01-environment-overview){target=_blank}  
...
- [VMware Cloud on AWS Immersion Day](https://catalog.workshops.aws/vmwarecloud/ja-JP){target=_blank}  
